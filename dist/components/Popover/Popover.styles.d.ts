export declare const PopoverStyled: import("@stitches/react/types/styled-component").StyledComponent<"div", {}, {}, import("@stitches/react/types/css-util").CSS<{}, {
    colors: {
        background: string;
        blueBorder: string;
        blueOverlay: string;
...
export declare const PopoverTriggerStyled: import("@stitches/react/types/styled-component").StyledComponent<"div", {}, {}, import("@stitches/react/types/css-util").CSS<{}, {
    colors: {
        background: string;
        blueBorder: string;
        blueOverlay: string;
