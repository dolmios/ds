export declare const StackRowStyled: import("@stitches/react/types/styled-component").StyledComponent<"div", {}, {}, import("@stitches/react/types/css-util").CSS<{}, {
    colors: {
        background: string;
        blueBorder: string;
        blueOverlay: string;
...
export declare const StackColumnStyled: import("@stitches/react/types/styled-component").StyledComponent<"div", {}, {}, import("@stitches/react/types/css-util").CSS<{}, {
    colors: {
        background: string;
        blueBorder: string;
        blueOverlay: string;
