export declare const ViewStyled: import("@stitches/react/types/styled-component").StyledComponent<"div", import("@stitches/react/types/styled-component").StyledComponentProps<[{
    paddingLeft: string;
    paddingRight: string;
    variants: {
        container: {
...
//# sourceMappingURL=View.styles.d.ts.map