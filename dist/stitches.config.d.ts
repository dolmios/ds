...
export declare const theme: string & {
    ...
    colors: {
        ...
        overlayActive: import("@stitches/react/types/theme").Token<"overlayActive", string, "colors", "">;
        overlayHover: import("@stitches/react/types/theme").Token<"overlayHover", string, "colors", "">;
